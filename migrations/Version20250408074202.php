 ...
 */
final class Version20250408074202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE appointment ADD patient_id INT NOT NULL, ADD specialist_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_FE38F8447B100C1A ON appointment (specialist_id)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_FE38F8447B100C1A ON appointment
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE appointment DROP patient_id, DROP specialist_id
        SQL);
    }
}
